...
The intent is to be round-trip lossless with tools such as compositor lab, but actually with a good IDE with intellisense such as vs code, and the blazing fast doc generator included, you may find you dont need such tools to get started.
