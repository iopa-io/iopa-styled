...
var node_modules = fs.pathExistsSync(path.resolve(__dirname, 'node_modules', 'prop-types')) ? path.resolve(__dirname, 'node_modules') : path.resolve(__dirname, '..', '..', 'node_modules');

// PROXY node modules
if (!fs.existsSync(path.resolve(node_modules, 'prop-types', '.$$$proxied'))) {
    fs.moveSync(path.resolve(node_modules, 'prop-types'), path.resolve(node_modules, 'react-prop-types'));
    fs.moveSync(path.resolve(node_modules, 'axe-prop-types'), path.resolve(node_modules, 'prop-types'));
    var js = fs.readFileSync(path.resolve(node_modules, 'prop-types', 'index.js'), { encoding: 'utf8' });
    js = js.replace("require('../prop-types')", "require('../react-prop-types')");
    fs.writeFileSync(path.resolve(node_modules, 'prop-types', 'index.js'), js, { encoding: 'utf8' });
    fs.writeFileSync(path.resolve(node_modules, 'prop-types', '.$$$proxied'), "");
    console.log("PROXIED")
}
...
var result = `// THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
// THIS FILE WAS GENERATED BY iopa-styled / styled-system-types
...
declare module 'styled-system-types' {
    export = StyledSystem;
  }
`
